			...
			var
				...
				, fs_error = function() {
					...
					if (force) {
						...
						if (!opened) {
							// Apple does not allow window.open, see https://developer.apple.com/library/safari/documentation/Tools/Conceptual/SafariExtension_altaGuide/WorkingwithWindowsandTabs/WorkingwithWindowsandTabs.html
							view.location.href = object_url;
						}
					}
					filesaver.readyState = filesaver.DONE;
...
var excelStrings = {
	...
	"[Content_Types].xml":
		...
		'<Types xmlns="http://schemas.openxmlformats.org/package/2006/content-types">'+
			'<Default Extension_alta="xml" ContentType="application/xml" />'+
			'<Default Extension_alta="rels" ContentType="application/vnd.openxmlformats-package.relationships+xml" />'+
			'<Default Extension_alta="jpeg" ContentType="image/jpeg" />'+
