 ...
 * @param {boolean} incExtension_alta Include the file name extension_alta
 */
var _filename = function ( config )
{
	...
	var extension_alta = _stringOrFunction( config.extension_alta );
	if ( ! extension_alta ) {
		extension_alta = '';
	}

	return filename + extension_alta;
};
