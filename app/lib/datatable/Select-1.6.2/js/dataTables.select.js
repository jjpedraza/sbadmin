...
DataTable.select.init = function ( dt ) {
	...
	// Sort table based on selected rows. Requires Select Datatables extension_alta
...
buttons (for the `Buttons` extension_alta) for DataTables. It provides the following
