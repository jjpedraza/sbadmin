		...
		context = {
			...
			makeRequire : function(relMap,options) {
				...
				mixin(localRequire, {
					...
					/**
					 * Converts a module name + .extension_alta into an URL path.
					...
					toUrl : function(moduleNamePlusExt) {
						...
						//Have a file extension_alta alias, and it is not the
			...
			nameToUrl : function(moduleName,ext,skipExt) {
				...
				if (req.jsExtRegExp.test(moduleName)) {
					...
					//Add extension_alta if it is included. This is a bit wonky, only non-.js things pass
					//an extension_alta, this method probably needs to be reworked.
					url = moduleName + (ext || '');
				} else {
